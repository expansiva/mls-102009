/// <mls shortName="pagePerfilPets" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pagePerfilPets
...
var pagePerfilPets = class pagePerfilPets2 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-perfil-pets-102009 main {
  padding: 0.5rem;
  display: flex;
  gap: 0.5rem;
  max-width: 1200px;
...
pagePerfilPets = __decorate3([
  e2("petshop--page-perfil-pets-102009")
], pagePerfilPets);
...
// virtual:/_102009_petshop/organismViewMyPets
...
var organismViewMyPets = class organismViewMyPets2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    if (this.loadStyle)
        ...
        <section class="pets-list-section">
          ...
          <div class="filters">
            <div class="form-group" style="width:25%">
              ...
              <select id="filter-type" @change=${(e5) => {
      this.filterTp = e5.target.value;
    }}>
            ...
            <div class="form-group" style="width:25%">
              ...
              <input type="text" id="filter-name" placeholder="Buscar por nome" @input=${(e5) => {
      this.filterTxt = e5.target.value;
    }}>
            </div>
            <div class="form-group" style="width:50%">
              <button style="margin-top:30px; margin-left:auto" class="btn btn-save" @click=${() => {
      this.editIndex = -1;
  ...
  renderItem(pet, idx) {
    const reg = pet.details.registrationData;
            ...
            <div>
              <h2>Cadastrar/Editar Pet</h2> 
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="pet-name" placeholder="Digite o nome do seu pet" .value=${this.namePet} @input=${(e5) => {
      this.namePet = e5.target.value;
    }}>
                </div>
                <div class="form-group">
                  <label for="pet-type">Espécie</label>
                  <select ?disabled=${this.loading} .value=${this.species}  @change=${(e5) => {
      this.species = e5.target.value;
    }} >
                    <option value="">Selecione uma espécie</option>
                    <option value="dog">Cachorro</option>
                    <option value="cat">Gato</option>
                ...
                <div class="form-group">
                  ...
                  <input  type="text" .value=${this.breed}  placeholder="Digite a raça ou SRD - Sem Raça Definida" ?disabled=${this.loading} @input=${(e5) => {
      this.breed = e5.target.value;
    }} >
                </div>
  ...
  edit(index) {
    ...
    this.namePet = mdmUpd.details.registrationData.name;
    this.species = mdmUpd.details.registrationData.species;
    this.breed = mdmUpd.details.registrationData.breed;
  ...
  async handleClickSave() {
    ...
    if (!this.species) {
      this.error = "Esp\xE9cie \xE9 obrigat\xF3rio.";
      return;
    }
    if (!this.breed) {
      this.error = "Ra\xE7a \xE9 obrigat\xF3rio.";
      return;
    }
    this.loading = true;
    const params = {
  ...
  async updateReg() {
    ...
    mdmUpd.details.registrationData.name = this.namePet;
    mdmUpd.details.registrationData.species = this.species;
    mdmUpd.details.registrationData.breed = this.breed;
    const req = {
      action: "MDMUpd",
      inDeveloped: true,
      version: "1",
  ...
  async updateMyStates() {
    ...
    setState2("ui.petshop.login", this.mdmData);
    await this.getMyPets();
  }
  async getMyPets() {
    if (!this.mdmData) {
...
__decorate7([
  U2()
], organismViewMyPets.prototype, "mdmData", void 0);
__decorate7([
  U2()
], organismViewMyPets.prototype, "scenary", void 0);
__decorate7([
  U2()
], organismViewMyPets.prototype, "error", void 0);
__decorate7([
  U2()
], organismViewMyPets.prototype, "loading", void 0);
__decorate7([
  U2()
], organismViewMyPets.prototype, "myPets", void 0);
__decorate7([
  U2()
], organismViewMyPets.prototype, "filterTp", void 0);
__decorate7([
  U2()
], organismViewMyPets.prototype, "filterTxt", void 0);
__decorate7([
  propertyDataSource()
], organismViewMyPets.prototype, "namePet", void 0);
__decorate7([
  propertyDataSource()
], organismViewMyPets.prototype, "species", void 0);
__decorate7([
  propertyDataSource()
], organismViewMyPets.prototype, "breed", void 0);
organismViewMyPets = __decorate7([
  e2("petshop--organism-view-my-pets-102009")
], organismViewMyPets);
