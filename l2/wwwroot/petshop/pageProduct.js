/// <mls shortName="pageProduct" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pageProduct
...
var PageProduct = class PageProduct2 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-product-102009 {
  display: flex;
  flex-direction: column;
  min-height: 100vh;
  background: var(--bg-primary-color);
}
petshop--page-product-102009 > body {
  flex: 1 1 auto;
  display: flex;
  flex-direction: column;
  min-height: 100vh;
...
petshop--page-product-102009 header {
  width: 100%;
  background: var(--bg-primary-color-lighter);
  box-shadow: 0 1px 0 var(--grey-color-light);
  z-index: 10;
}
petshop--page-product-102009 main {
  display: flex;
  flex: 1 1 auto;
  flex-direction: row;
  gap: var(--space-32);
...
petshop--page-product-102009 aside {
  min-width: 260px;
  max-width: 320px;
}
@media (max-width: 768px) {
...
petshop--page-product-102009 footer {
  width: 100%;
  background: var(--bg-primary-color-lighter);
  margin-top: auto;
  box-shadow: 0 -1px 0 var(--grey-color-light);
...
PageProduct = __decorate3([
  e2("petshop--page-product-102009")
], PageProduct);
...
// virtual:/_102009_petshop/organismProductList
...
var organismProductList = class organismProductList2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    if (this.loadStyle)
...
organismProductList = __decorate6([
  e2("petshop--organism-product-list-102009")
], organismProductList);

// virtual:/_102009_petshop/organismCartSummary
...
var organismCartSummary = class organismCartSummary2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    if (this.loadStyle)
...
organismCartSummary = __decorate7([
  e2("petshop--organism-cart-summary-102009")
], organismCartSummary);
