/// <mls shortName="pageAdminAddProduct" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pageAdminAddProduct
...
var PageAdminAddProduct102009 = class PageAdminAddProduct1020092 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-admin-add-product-102009 {
  display: flex;
}
petshop--page-admin-add-product-102009 main {
  height: 100vh;
  overflow: auto;
  width: 100%;
}
@media (max-width: 768px) {
  petshop--page-admin-add-product-102009 {
...
PageAdminAddProduct102009 = __decorate3([
  e2("petshop--page-admin-add-product-102009")
], PageAdminAddProduct102009);
...
// virtual:/_102009_petshop/organismAdminAddProduct
...
var organismAddProduct = class organismAddProduct2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    if (this.loadStyle)
      this.loadStyle(`petshop--organism-admin-add-product-102009{display:block;padding:var(--space-24);background-color:var(--bg-primary-color)}`);
    this.loading = false;
  }
  connectedCallback() {
    super.connectedCallback();
    ...
    return Z`<div>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    @input=${(e6) => {
      this.nameProduct = e6.target.value;
    }}
                    >
            </div>
            <div class="form-group">
...
organismAddProduct = __decorate6([
  e2("petshop--organism-admin-add-product-102009")
], organismAddProduct);
/**
 * @license
