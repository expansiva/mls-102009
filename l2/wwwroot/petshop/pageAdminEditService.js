/// <mls shortName="pageAdminEditService" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pageAdminEditService
...
var PageAdminEditService102009 = class PageAdminEditService1020092 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-admin-edit-service-102009 {
  display: flex;
}
petshop--page-admin-edit-service-102009 main {
  height: 100vh;
  overflow: auto;
  width: 100%;
}
@media (max-width: 768px) {
  petshop--page-admin-edit-service-102009 {
...
`);
  ...
  initPage() {
    ...
    const selected = getState2("ui.petshop.admin.service.selected");
    const serviceData = selected?.details?.registrationData;
    const serviceDataMore = selected?.details?.serviceData;
    initState2("ui.petshop.admin.organismAdminServiceEdit", {
...
PageAdminEditService102009 = __decorate3([
  e2("petshop--page-admin-edit-service-102009")
], PageAdminEditService102009);
...
// virtual:/_102009_petshop/organismAdminServiceEdit
...
var organismAdminServiceEdit = class organismAdminServiceEdit2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    if (this.loadStyle)
      this.loadStyle(`petshop--organism-admin-service-edit-102009{display:block;padding:var(--space-24);background-color:var(--bg-primary-color)}`);
    this.loading = false;
  }
  firstUpdated(_changedProperties) {
    super.firstUpdated(_changedProperties);
    const data = getState2("ui.petshop.admin.service.selected");
    this.mdmData = data;
  }
  render() {
    return Z`<div class="form-container" id="petshop--organism-admin-service-edit-102009-1"
>
...
`;
  ...
  handleInputChange(event) {
    ...
    switch (id) {
      ...
      case "speciesSuitability":
        this.speciesSuitability = value.split(",").map((s4) => s4.trim()).filter((s4) => s4);
        break;
      case "sizeSuitability":
        this.sizeSuitability = value.split(",").map((s4) => s4.trim()).filter((s4) => s4);
        break;
      case "requiredResources":
        this.requiredResources = value.split(",").map((s4) => s4.trim()).filter((s4) => s4);
        break;
  ...
  async handleClickSave() {
    ...
    let hasErrors = false;
    if (!this.nameService) {
      this.labelError = "Nome do servi\xE7o \xE9 obrigat\xF3rio.";
      hasErrors = true;
    } else if (!this.descriptionShort) {
      this.labelError = "Descri\xE7\xE3o do servi\xE7o \xE9 obrigat\xF3rio.";
      hasErrors = true;
    }
    if (!hasErrors) {
      this.loading = true;
      ...
      if (!dataToUpd.details.serviceData) {
        dataToUpd.details.serviceData = {
          category: "",
          durationMinutes: 0,
          priceRegular: 0,
      ...
      const serviceData = dataToUpd.details.serviceData;
...
organismAdminServiceEdit = __decorate6([
  e2("petshop--organism-admin-service-edit-102009")
