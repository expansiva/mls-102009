/// <mls shortName="pageAdminService" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pageAdminService
...
var PageAdminService102009 = class PageAdminService1020092 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-admin-service-102009 {
  display: flex;
}
petshop--page-admin-service-102009 main {
  height: 100vh;
  overflow: auto;
  width: 100%;
}
@media (max-width: 768px) {
  petshop--page-admin-service-102009 {
...
`);
  ...
  initPage() {
    setState2("ui.petshop.admin.menu.selected", "service");
  }
};
PageAdminService102009 = __decorate3([
  e2("petshop--page-admin-service-102009")
], PageAdminService102009);
...
// virtual:/_102009_petshop/organismAdminServicesList
...
var organismAdminServicesList = class organismAdminServicesList2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    if (this.loadStyle)
      this.loadStyle(`petshop--organism-admin-services-list-102009{display:block;padding:var(--space-24);background-color:var(--bg-primary-color)}petshop--organism-admin-services-list-102009 .filters{margin-bottom:var(--space-24);display:inline-flex;gap:1rem;width:100%}petshop--organism-admin-services-list-102009 .filters a{color:#ffffff}petshop--organism-admin-services-list-102009 .filters .form-group-add{margin-left:auto;margin-bottom:var(--space-16);margin-top:auto}petshop--organism-admin-services-list-102009 .filter-controls{display:flex;gap:var(--space-8);align-items:center;justify-content:space-between}petshop--organism-admin-services-list-102009 .filter-controls input{width:300px}petshop--organism-admin-services-list-102009 .filter-controls a{color:#ffffff}petshop--organism-admin-services-list-102009 th{cursor:pointer}petshop--organism-admin-services-list-102009 th:hover{background-color:var(--bg-secondary-color-hover)}@media (max-width:768px){petshop--organism-admin-services-list-102009 .organism-admin-service-list{padding:var(--space-16)}petshop--organism-admin-services-list-102009 .filter-controls{flex-direction:column;align-items:stretch}petshop--organism-admin-services-list-102009 .filter-controls input{width:100%}}`);
    this.filterText = "";
  ...
  get filteredServices() {
    if (!this.mdmServices)
      return [];
    return this.mdmServices.filter((mdmServices) => mdmServices.details.registrationData?.name.toLowerCase().includes(this.filterText.toLowerCase()) || mdmServices.details.registrationData?.descriptionShort.toLowerCase().includes(this.filterText.toLowerCase()) || mdmServices.details.registrationData?.serviceCode?.toLowerCase().includes(this.filterText.toLowerCase()));
  }
  get sortedServices() {
  ...
  handleEdit(e6, service) {
    e6.preventDefault();
    setState2("ui.petshop.admin.service.selected", service);
    if (this.linkToEdit)
    ...
    return Z`
		<div class="organism-admin-services-list" id="petshop--organism-admin-services-list-102009-1">
			...
			<div class="form-group" id="petshop--organism-admin-services-list-102009-3">
				...
				<div class="filter-controls">
					<input
						...
						@input="${(e6) => this.filterText = e6.target.value}"
					>
			...
			<table id="petshop--organism-admin-services-list-102009-5">
				...
				<tbody>
					${this.paginatedServices.map((service) => Z`
						<tr>
							<td>${service.details.registrationData?.name}</td>
							<td>${service.details.registrationData?.descriptionShort}</td>
							<td>${service.details.registrationData?.serviceCode}</td>

							<td>
								<a href="#" @click="${(e6) => this.handleEdit(e6, service)}">Editar</a>
							</td>
						</tr>
					`)}
				</tbody>
...
__decorate6([
  U2()
], organismAdminServicesList.prototype, "mdmServices", void 0);
__decorate6([
  U2()
], organismAdminServicesList.prototype, "filterText", void 0);
__decorate6([
  U2()
], organismAdminServicesList.prototype, "sortColumn", void 0);
__decorate6([
  U2()
], organismAdminServicesList.prototype, "sortDirection", void 0);
__decorate6([
  U2()
], organismAdminServicesList.prototype, "currentPage", void 0);
__decorate6([
  U2()
], organismAdminServicesList.prototype, "itemsPerPage", void 0);
__decorate6([
  t5("#link-to-edit")
], organismAdminServicesList.prototype, "linkToEdit", void 0);
organismAdminServicesList = __decorate6([
  e2("petshop--organism-admin-services-list-102009")
], organismAdminServicesList);
/**
 * @license
