/// <mls shortName="adminPanel" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/adminPanel
...
var PageAdminPanel = class PageAdminPanel2 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--admin-panel-102009 {
  display: flex;
  flex-direction: column;
  min-height: 100vh;
  background: var(--bg-primary-color);
}
petshop--admin-panel-102009 header {
  flex: 0 0 auto;
  width: 100%;
  z-index: 10;
}
petshop--admin-panel-102009 aside {
  flex: 0 0 240px;
  min-width: 220px;
  background: var(--bg-secondary-color-lighter);
  z-index: 5;
}
petshop--admin-panel-102009 main {
  flex: 1 1 auto;
  display: flex;
  flex-direction: column;
  gap: var(--space-32);
...
petshop--admin-panel-102009 footer {
  flex: 0 0 auto;
  width: 100%;
...
PageAdminPanel = __decorate3([
  e2("petshop--admin-panel-102009")
], PageAdminPanel);
...
// virtual:/_102009_petshop/organismAdminSidebar
...
var organismAdminSidebar = class organismAdminSidebar2 extends IcaOrganismBase {
  constructor() {
    super();
    if (this.loadStyle)
  ...
  render() {
    return Z`<aside class="admin-sidebar" id="petshop--admin-sidebar-102009-1">
...
organismAdminSidebar = __decorate6([
  e2("petshop--organism-admin-sidebar-102009")
], organismAdminSidebar);

// virtual:/_102009_petshop/organismAdminDashboard
...
var organismAdminDashboard = class organismAdminDashboard2 extends IcaOrganismBase {
  constructor() {
    super();
    if (this.loadStyle)
  ...
  render() {
    return Z`<section class="admin-dashboard" id="dashboard">
...
organismAdminDashboard = __decorate7([
  e2("petshop--organism-admin-dashboard-102009")
...
// virtual:/_102009_petshop/organismAdminBookings
...
var OrganismAdminBookings = class OrganismAdminBookings2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    if (this.loadStyle)
  ...
  handleEdit(e6, scheduling) {
    e6.preventDefault();
    setState2("ui.petshop.admin.scheduling.selected", scheduling);
    if (this.linkToEdit)
      this.linkToEdit.click();
  }
  handleSearch(e6) {
    this.search = e6.target.value.toLowerCase();
    this.applyFilters();
  }
  handleStatusFilter(e6) {
    this.statusFilter = e6.target.value;
    this.applyFilters();
  }
  handleDateStartFilter(e6) {
    this.filterDateStart = e6.target.value;
    this.applyFilters();
  }
  handleDateEndFilter(e6) {
    this.filterDateEnd = e6.target.value;
    this.applyFilters();
  }
  handleServiceFilter(e6) {
    this.filterService = e6.target.value;
    this.applyFilters();
  }
  applyFilters() {
    let list = [...this.schedulings];
    if (this.search) {
      list = list.filter((b4) => b4.details.tutor.name.toLowerCase().includes(this.search) || b4.details.pet.name.toLowerCase().includes(this.search));
    }
    if (this.statusFilter) {
      list = list.filter((b4) => b4.details.status === this.statusFilter);
    }
    ...
    if (startDate || endDate) {
      list = list.filter((b4) => {
        const date = new Date(b4.details.startDateTime);
        ...
        if (startDate && endDate) {
          return d4 >= startDate && d4 <= endDate;
        } else if (startDate) {
    ...
    if (this.filterService) {
      list = list.filter((b4) => b4.details.service.name === this.filterService);
    }
    this.currentPage = 1;
    this.filtered = list;
  }
...
<h2 class="admin-bookings__title">${this.titleHeader || "Gest\xE3o de Agendamentos"}</h2>
	${this.mode === "with-filter" ? Z`
		<div class="admin-bookings__filters">
			...
			<select @change=${this.handleServiceFilter}>
				...
				${this.getUniqueServices().map((service) => Z`<option value="${service}">${service}</option>`)}
			</select>
	...
	<table class="admin-bookings__table">
		...
		<tbody>
			${this.paginated.map((b4) => Z`
			<tr>
				<td>${b4.details.tutor.name}</td>
				<td>${b4.details.pet.name}</td>
				<td>${b4.details.service.name}</td>
				<td>${new Date(b4.details.startDateTime).toLocaleString()}</td>
				<td>
					<span class="admin-bookings__status admin-bookings__${this.getStatusCls(b4.details.status)}">
					${this.getStatusLabel(b4.details.status)}
					</span>
				</td>
				<td class="admin-bookings__action_td">
					<a href="#" @click="${(e6) => this.handleEdit(e6, b4)}">Detalhes</button>
				</td>
			</tr>
			`)}
		</tbody>
...
`;
  ...
  getUniqueServices() {
    const services = this.schedulings.map((b4) => b4.details.service.name);
...
OrganismAdminBookings = __decorate8([
  e2("petshop--organism-admin-bookings-102009")
], OrganismAdminBookings);

// virtual:/_102009_petshop/organismAdminProducts
...
var organismAdminProducts = class organismAdminProducts2 extends IcaOrganismBase {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--organism-admin-products-102009 .admin-products{background:var(--bg-primary-color);padding:var(--space-32);font-family:var(--font-family-primary)}petshop--organism-admin-products-102009 .admin-products .admin-products__title{font-size:var(--font-size-20);color:var(--text-primary-color-darker);margin-bottom:var(--space-24);font-weight:var(--font-weight-bold)}petshop--organism-admin-products-102009 .admin-products .admin-products__actions{margin-bottom:var(--space-16)}petshop--organism-admin-products-102009 .admin-products .admin-products__actions .admin-products__add{background:var(--success-color);color:#fff;border:none;border-radius:4px;padding:var(--space-8) var(--space-16);font-size:var(--font-size-16);cursor:pointer;font-weight:var(--font-weight-bold);transition:background var(--transition-slow)}petshop--organism-admin-products-102009 .admin-products .admin-products__actions .admin-products__add:hover,petshop--organism-admin-products-102009 .admin-products .admin-products__actions .admin-products__add:focus{background:var(--success-color-hover)}petshop--organism-admin-products-102009 .admin-products .admin-products__table{width:100%;border-collapse:collapse;background:var(--bg-secondary-color-lighter);border-radius:8px;overflow:hidden}petshop--organism-admin-products-102009 .admin-products .admin-products__table th,petshop--organism-admin-products-102009 .admin-products .admin-products__table td{padding:var(--space-16);text-align:left;font-size:var(--font-size-16)}petshop--organism-admin-products-102009 .admin-products .admin-products__table th{background:var(--bg-primary-color-darker);color:var(--text-primary-color-lighter);font-weight:var(--font-weight-bold)}petshop--organism-admin-products-102009 .admin-products .admin-products__table tr{border-bottom:1px solid var(--grey-color-light)}petshop--organism-admin-products-102009 .admin-products .admin-products__table tr:last-child{border-bottom:none}petshop--organism-admin-products-102009 .admin-products .admin-products__img{width:48px;height:48px;object-fit:cover;border-radius:8px}petshop--organism-admin-products-102009 .admin-products .admin-products__status{padding:0 var(--space-8);border-radius:12px;font-size:var(--font-size-12);font-weight:var(--font-weight-bold)}petshop--organism-admin-products-102009 .admin-products .admin-products__status--active{background:var(--success-color);color:#fff}petshop--organism-admin-products-102009 .admin-products .admin-products__status--inactive{background:var(--grey-color-dark);color:var(--text-primary-color-lighter)}petshop--organism-admin-products-102009 .admin-products .admin-products__action{background:var(--bg-primary-color-darker);color:var(--text-primary-color-lighter);border:none;border-radius:4px;padding:var(--space-8) var(--space-16);margin-right:var(--space-8);font-size:var(--font-size-12);cursor:pointer;transition:background var(--transition-slow)}petshop--organism-admin-products-102009 .admin-products .admin-products__action:hover,petshop--organism-admin-products-102009 .admin-products .admin-products__action:focus{background:var(--active-color-hover)}petshop--organism-admin-products-102009 .admin-products .admin-products__action--edit{background:var(--info-color)}petshop--organism-admin-products-102009 .admin-products .admin-products__action--edit:hover,petshop--organism-admin-products-102009 .admin-products .admin-products__action--edit:focus{background:var(--info-color-hover)}petshop--organism-admin-products-102009 .admin-products .admin-products__action--remove{background:var(--error-color)}petshop--organism-admin-products-102009 .admin-products .admin-products__action--remove:hover,petshop--organism-admin-products-102009 .admin-products .admin-products__action--remove:focus{background:var(--error-color-hover)}@media (max-width:768px){petshop--organism-admin-products-102009 .admin-products__table,petshop--organism-admin-products-102009 .admin-products__table th,petshop--organism-admin-products-102009 .admin-products__table td{font-size:var(--font-size-12);padding:var(--space-8)}petshop--organism-admin-products-102009 .admin-products__img{width:32px;height:32px}}`);
  }
  render() {
    return Z`<section class="admin-products" id="products">
...
organismAdminProducts = __decorate9([
  e2("petshop--organism-admin-products-102009")
], organismAdminProducts);

// virtual:/_102009_petshop/organismAdminContent
...
var organismAdminContent = class organismAdminContent2 extends IcaOrganismBase {
  constructor() {
    super();
    if (this.loadStyle)
  ...
  render() {
    return Z`<section class="admin-content" id="content">
...
organismAdminContent = __decorate10([
  e2("petshop--organism-admin-content-102009")
...
organismFooterInfo = __decorate11([
