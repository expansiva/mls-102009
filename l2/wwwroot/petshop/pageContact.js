/// <mls shortName="pageContact" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pageContact
...
var PageContact = class PageContact2 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-contact-102009 {
  display: flex;
  flex-direction: column;
  min-height: 100vh;
  background: var(--bg-primary-color);
}
petshop--page-contact-102009 header {
  flex: 0 0 auto;
}
petshop--page-contact-102009 main {
  flex: 1 0 auto;
  display: flex;
  flex-direction: row;
...
petshop--page-contact-102009 footer {
  flex: 0 0 auto;
}
`);
  }
...
PageContact = __decorate3([
  e2("petshop--page-contact-102009")
], PageContact);
...
// virtual:/_102009_petshop/organismContactForm
...
organismContactForm = __decorate6([
  e2("petshop--organism-contact-form-102009")
], organismContactForm);

// virtual:/_102009_petshop/organismContactDetails
...
var organismContactDetails = class organismContactDetails2 extends IcaOrganismBase {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--organism-contact-details-102009{background:var(--bg-primary-color);border-radius:var(--space-16);box-shadow:0 2px 12px 0 rgba(211,211,211,0.1);padding:var(--space-48) var(--space-40);min-width:320px;max-width:400px;width:100%;display:flex;flex-direction:column;gap:var(--space-24);font-family:var(--font-family-primary)}petshop--organism-contact-details-102009 h2{color:var(--text-primary-color);font-size:var(--font-size-24);font-weight:var(--font-weight-bold);margin-bottom:var(--space-16)}petshop--organism-contact-details-102009 .contact-info{display:flex;flex-direction:column;gap:var(--space-16);font-size:var(--font-size-16);color:var(--text-primary-color-darker)}petshop--organism-contact-details-102009 .contact-item{display:flex;align-items:center;gap:var(--space-16);line-height:var(--line-height-large)}petshop--organism-contact-details-102009 .contact-icon{width:28px;height:28px;display:flex;align-items:center;justify-content:center;background:var(--bg-secondary-color-lighter);border-radius:50%;color:var(--text-primary-color);font-size:var(--font-size-20)}petshop--organism-contact-details-102009 .contact-label{font-weight:var(--font-weight-bold);margin-right:var(--space-8)}petshop--organism-contact-details-102009 .social-links{display:flex;gap:var(--space-16);margin-top:var(--space-16)}petshop--organism-contact-details-102009 .social-link{display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:50%;background:var(--bg-secondary-color-lighter);color:var(--text-primary-color);font-size:var(--font-size-20);transition:background var(--transition-normal),color var(--transition-normal);text-decoration:none}petshop--organism-contact-details-102009 .social-link:hover{background:var(--text-primary-color);color:var(--bg-primary-color)}`);
  }
  render() {
    return Z`<h2 id="petshop--contact-details-102009-1">Contato</h2>
...
organismContactDetails = __decorate7([
  e2("petshop--organism-contact-details-102009")
], organismContactDetails);
