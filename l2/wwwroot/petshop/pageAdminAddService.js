/// <mls shortName="pageAdminAddService" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pageAdminAddService
...
var PageAdminAddService102009 = class PageAdminAddService1020092 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-admin-add-service-102009 {
  display: flex;
}
petshop--page-admin-add-service-102009 main {
  height: 100vh;
  overflow: auto;
  width: 100%;
}
@media (max-width: 768px) {
  petshop--page-admin-add-service-102009 {
...
PageAdminAddService102009 = __decorate3([
  e2("petshop--page-admin-add-service-102009")
], PageAdminAddService102009);
...
// virtual:/_102009_petshop/organismAdminAddService
...
var organismAddService = class organismAddService2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    if (this.loadStyle)
      this.loadStyle(`petshop--organism-admin-add-service-102009{display:block;padding:var(--space-24);background-color:var(--bg-primary-color)}`);
    this.loading = false;
  }
  connectedCallback() {
    super.connectedCallback();
  ...
  render() {
    return Z`<div id="petshop--organism-add-service-102009-1">
            ...
            <div class="form-group" id="petshop--organism-add-service-102009-3">
                ...
                <input 
                    ...
                    @input=${(e6) => {
      this.nameService = e6.target.value;
    }}
                >
            </div>
            <div class="form-group" id="petshop--organism-add-service-102009-6">
                ...
                <textarea 
                    ...
                    ?disabled=${this.loading}
                    @input=${(e6) => {
      this.descriptionShort = e6.target.value;
    }}
                ></textarea>
            </div>
            <div class="form-group" id="petshop--organism-add-service-102009-9">
                ...
                <input 
                    ...
                    ?disabled=${this.loading}
                    @input=${(e6) => {
      this.serviceCode = e6.target.value;
    }}
                >
            </div>
...
organismAddService = __decorate6([
  e2("petshop--organism-admin-add-service-102009")
], organismAddService);
/**
 * @license
