/// <mls shortName="pageAdminOrderEdit" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pageAdminOrderEdit
...
var PageAdminOrderEdit102009 = class PageAdminOrderEdit1020092 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-admin-order-edit-102009 {
  display: flex;
}
petshop--page-admin-order-edit-102009 main {
  height: 100vh;
  overflow: auto;
  width: 100%;
}
@media (max-width: 768px) {
  petshop--page-admin-order-edit-102009 {
...
PageAdminOrderEdit102009 = __decorate3([
  e2("petshop--page-admin-order-edit-102009")
], PageAdminOrderEdit102009);
...
// virtual:/_102009_petshop/organismAdminOrderEdit
...
var organismAdminOrderEdit = class organismAdminOrderEdit2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    this.loading = false;
    this.employees = [];
  ...
  async firstUpdated(_changedProperties) {
    super.firstUpdated(_changedProperties);
    const data = getState2("ui.petshop.admin.order.selected");
    this.orderData = data;
...
<input type="text" id="service" .value=${this.service?.details.registrationData?.name} readonly >
</div>
<div class="form-group">
...
${this.labelOk ? Z`<span class="ok-message">${this.labelOk}</span>` : ""}
  ...
  onChangeStatus(e5) {
    ...
    if (!this.orderData)
      return;
    this.orderData.details.status = value;
  }
  onChangeBilling(e5) {
    const value = e5.target.value;
    if (!this.orderData)
  ...
  onChangeEmployer(e5) {
    ...
    const name = selected.details.type === MdmType.PessoaFisica ? selected.details.registrationData.name : selected.details.registrationData.fantasyName;
  ...
  async handleSave() {
    if (!this.orderData) {
      this.labelError = "N\xE3o encontrado informa\xE7\xF5es da ordem de servi\xE7o";
      return;
    }
    this.labelError = "";
    this.loading = true;
    ...
    this.labelOk = "Ordem de servi\xE7o atualizada com sucesso";
  }
};
__decorate6([
  U2()
...
organismAdminOrderEdit = __decorate6([
  e2("petshop--organism-admin-order-edit-102009")
