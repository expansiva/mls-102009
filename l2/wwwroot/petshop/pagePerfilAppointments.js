/// <mls shortName="pagePerfilAppointments" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pagePerfilAppointments
...
var pagePerfilAppointments = class pagePerfilAppointments2 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-perfil-appointments-102009 main {
  padding: 0.5rem;
  display: flex;
  gap: 0.5rem;
  max-width: 1200px;
...
pagePerfilAppointments = __decorate3([
  e2("petshop--page-perfil-appointments-102009")
], pagePerfilAppointments);
        ...
        <div class="form-container">
            ...
            <div style="display:flex">
                <div class="form-group" style="width:70%">
                    ...
                    <input type="date" id="date-filter" name="date-filter" @change=${(e5) => this.filterData = e5.target.value}>
                </div>
...
organismViewMyAppointments = __decorate7([
