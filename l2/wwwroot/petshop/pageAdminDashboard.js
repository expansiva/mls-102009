/// <mls shortName="pageAdminDashboard" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pageAdminDashboard
...
var PageAdminDashboard102009 = class PageAdminDashboard1020092 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-admin-dashboard-102009 {
  display: flex;
}
petshop--page-admin-dashboard-102009 main {
  height: 100vh;
  overflow: auto;
  width: 100%;
}
@media (max-width: 768px) {
  petshop--page-admin-dashboard-102009 {
...
`);
  ...
  initPage() {
    setState2("ui.petshop.admin.menu.selected", "dashboard");
  }
};
PageAdminDashboard102009 = __decorate3([
  e2("petshop--page-admin-dashboard-102009")
], PageAdminDashboard102009);
...
organismAdminDashboard = __decorate6([
...
OrganismAdminBookings = __decorate7([
