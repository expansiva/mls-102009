/// <mls shortName="pageAdminEditProduct" project="102009" enhancement="_blank" folder="wwwroot/petshop" />
// virtual:lit
var t = globalThis;
...
// virtual:/_102009_petshop/pageAdminEditProduct
...
var PageAdminEditProduct102009 = class PageAdminEditProduct1020092 extends CollabPageElement {
  constructor() {
    super();
    if (this.loadStyle)
      this.loadStyle(`petshop--page-admin-edit-product-102009 {
  display: flex;
}
petshop--page-admin-edit-product-102009 main {
  height: 100vh;
  overflow: auto;
  width: 100%;
}
@media (max-width: 768px) {
  petshop--page-admin-edit-product-102009 {
...
`);
  ...
  initPage() {
    ...
    const selected = getState2("ui.petshop.admin.product.selected");
    const productData = selected?.details?.registrationData;
    const productDataMore = selected?.details?.productData;
    initState2("ui.petshop.admin.organismAdminProductEdit", {
...
PageAdminEditProduct102009 = __decorate3([
  e2("petshop--page-admin-edit-product-102009")
], PageAdminEditProduct102009);
...
// virtual:/_102009_petshop/organismAdminProductEdit
...
var organismAdminProductEdit = class organismAdminProductEdit2 extends IcaOrganismBase {
  constructor() {
    super(...arguments);
    this.loading = false;
  }
  firstUpdated(_changedProperties) {
    super.firstUpdated(_changedProperties);
    const data = getState2("ui.petshop.admin.product.selected");
    this.mdmData = data;
  }
  render() {
    return Z`<div class="form-container" id="petshop--organism-admin-product-edit-102009-1">
    ...
    ${this.labelOk ? Z`<span class="ok-message">${this.labelOk}</span>` : ""}
  ...
  async handleClickSave() {
    ...
    let hasErrors = false;
    if (!this.nameProduct) {
      this.labelError = "Nome do produto \xE9 obrigat\xF3rio.";
      hasErrors = true;
    } else if (!this.descriptionShort) {
      this.labelError = "Descri\xE7\xE3o do produto \xE9 obrigat\xF3rio.";
      hasErrors = true;
    }
    if (!hasErrors) {
      this.loading = true;
      ...
      if (!dataToUpd.details.productData) {
        dataToUpd.details.productData = {
          category: "",
          barcode: "",
          petSuitability: [],
          productDetails: "",
      ...
      const productData = dataToUpd.details.productData;
...
__decorate6([
  U2()
], organismAdminProductEdit.prototype, "loading", void 0);
__decorate6([
  U2()
], organismAdminProductEdit.prototype, "mdmData", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "nameProduct", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "descriptionShort", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "sku", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "barcode", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "category", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "subcategory", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "unitOfMeasure", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "petSuitability", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "productDetails", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "labelError", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "labelOk", void 0);
__decorate6([
  propertyDataSource()
], organismAdminProductEdit.prototype, "action", void 0);
__decorate6([
  t5("#link-back")
], organismAdminProductEdit.prototype, "link", void 0);
organismAdminProductEdit = __decorate6([
  e2("petshop--organism-admin-product-edit-102009")
], organismAdminProductEdit);
/**
 * @license
