/// <mls shortName="organismAdminSidebar" project="102009" folder="petshop" groupName="petshop" enhancement="_blank" />
...
export const defs: mls.l4.BaseDefs = {
  "meta": {
    "projectId": 102009,
    "folder": "petshop",
    "shortName": "organismAdminSidebar",
    "type": "organism",
  ...
  "planning": {
    "generalDescription": "Barra lateral do painel administrativo.",
