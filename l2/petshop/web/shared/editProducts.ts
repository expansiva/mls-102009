...
pageSubtitle: 'Simula cambios de productos y envía un autor explícito al registro de auditoría.',
preparingProducts: 'Preparando productos...',
loadingProducts: 'Cargando productos...',
couldNotLoadProducts: 'No se pudieron cargar los productos.',
productsLoaded: 'productos cargados',
authorLabel: 'Autor',
authorHint: 'Este valor se envía al registro de auditoría como el usuario simulado.',
sectionTitle: 'Editar productos',
fieldName: 'Nombre',
fieldCategory: 'Categoría',
fieldPriceInCents: 'Precio en centavos',
fieldHighlightScore: 'Puntuación de destaque',
fieldStockStatus: 'Estado de stock',
...
updated: 'Actualizado',
by: 'por',
couldNotUpdate: 'No se pudo actualizar el producto.',
couldNotSave: 'No se pudo guardar el producto',
};
const message_af = {
brand: 'Petshop',
pageTitle: 'Redigeer produkte',
pageSubtitle: 'Simuleer produkveranderinge en stuur ’n eksplisiete outeur na die ouditspoor.',
preparingProducts: 'Berei produkte voor...',
loadingProducts: 'Laai produkte...',
couldNotLoadProducts: 'Kon nie produkte laai nie.',
productsLoaded: 'produkte gelaai',
authorLabel: 'Outeur',
authorHint: 'Hierdie waarde word na die ouditspoor gestuur as die gesimuleerde gebruiker.',
sectionTitle: 'Redigeer produkte',
fieldName: 'Naam',
fieldCategory: 'Kategorie',
fieldPriceInCents: 'Prys in sent',
fieldHighlightScore: 'Uitlig-telling',
fieldStockStatus: 'Voorraadstatus',
fieldDescription: 'Beskrywing',
lastUpdate: 'Laaste opdatering:',
save: 'Stoor',
saving: 'Stoor tans',
updated: 'Opgedateer',
by: 'deur',
couldNotUpdate: 'Kon nie die produk opdateer nie.',
couldNotSave: 'Kon nie die produk stoor nie',
};
const message_it = {
brand: 'Petshop',
pageTitle: 'Modifica prodotti',
pageSubtitle: 'Simula modifiche ai prodotti e invia un autore esplicito al registro di audit.',
preparingProducts: 'Preparazione dei prodotti...',
loadingProducts: 'Caricamento dei prodotti...',
couldNotLoadProducts: 'Impossibile caricare i prodotti.',
productsLoaded: 'prodotti caricati',
authorLabel: 'Autore',
authorHint: 'Questo valore viene inviato al registro di audit come utente simulato.',
sectionTitle: 'Modifica prodotti',
fieldName: 'Nome',
fieldCategory: 'Categoria',
fieldPriceInCents: 'Prezzo in centesimi',
fieldHighlightScore: 'Punteggio di evidenza',
fieldStockStatus: 'Stato delle scorte',
...
updated: 'Aggiornato',
by: 'da',
couldNotUpdate: 'Impossibile aggiornare il prodotto.',
couldNotSave: 'Impossibile salvare il prodotto',
};
